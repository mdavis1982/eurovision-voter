  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6">
    <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
      <div class="flex justify-start lg:w-0 lg:flex-1">
        <a href="#">
          <span class="sr-only">Eurovision Voting</span>
          <x-application-logo class="h-8 w-auto sm:h-14" />
        </a>
      </div>
      ...
      <nav class="hidden md:flex space-x-10" x-data="{ servicesOpen: false }">
        <div class="relative">
          <!-- Item active: "text-gray-900", Item inactive: "text-gray-500" -->
          <button @click.away="servicesOpen = false" @click="servicesOpen = !servicesOpen" type="button" class="text-gray-500 group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500" aria-expanded="false">
            <span>Services</span>
            <!--
          ...
          -->
          <div class="absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2" x-show="servicesOpen" x-cloak>
      ...
      <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
        ...
        <a href="#" class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-cyan-700 hover:bg-cyan-800">
          Sign up
        </a>
      </div>
    </div>
